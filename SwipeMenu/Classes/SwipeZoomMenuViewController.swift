...
public protocol SwipeZoomMenuInput {
...
public class SwipeZoomMenuViewController: UIViewController {
...
extension SwipeZoomMenuViewController: SwipeZoomMenuInput {
    ...
    public func setConfiguration(configuration: SwipeZoomMenuViewController.Configuration) {
        self.configuration = configuration
    }
    
    public func setContentController(vc: UIViewController) {
        self.contentVC = vc
    ...
    public func setMenuController(vc: UIViewController) {
        self.menuVC = vc
    ...
    public func openMenu(completion: SwipeZoomMenuInput.Completion? = nil) {
    ...
    public func closeMenu(completion: SwipeZoomMenuInput.Completion? = nil) {
